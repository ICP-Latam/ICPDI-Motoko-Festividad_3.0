...
import { idlFactory } from './Festividad_backend.did.js';
export { idlFactory } from './Festividad_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FESTIVIDAD_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Festividad_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Festividad_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Festividad_backend.did.js")._SERVICE>}
 */
export const Festividad_backend = createActor(canisterId);
